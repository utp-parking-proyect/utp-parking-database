...
-- Volcando estructura para tabla db_utp_parking.cycles
CREATE TABLE IF NOT EXISTS `cycles` (
  `id_cycle` int(11) NOT NULL,
  `name_cycle` varchar(50) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `requests` (
  ...
  KEY `fk_request_cycle` (`id_cycle`) USING BTREE,
  ...
  CONSTRAINT `fk_request_cycle` FOREIGN KEY (`id_cycle`) REFERENCES `cycles` (`id_cycle`) ON DELETE NO ACTION ON UPDATE NO ACTION,
